...
// 1. activity_main.xml에 FragmentContainerView를 배치해 준다.
// 2. MainActivity.kt 파일에 Fragment들의 이름을 표현하기 위한 enum class를 작성해준다.
// 3. MainActivity에 oldFragment와 newFragment 프로퍼티를 정의해준다.
// 4. fragment basic code.txt에 있는 메서드 코드를 붙여넣는다
// 5. 빨간색으로 뜨는 부분들 import설정 해준다.
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        replaceFragment(FragmentName.MAIN_FRAGMENT, addToBackStack = false, isAnimate = false, data = null)
    }
